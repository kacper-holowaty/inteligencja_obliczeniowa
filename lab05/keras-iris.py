...
# Przykładowa zmiana optymalizatora na SGD
# model.compile(optimizer='sgd', loss='categorical_crossentropy', metrics=['accuracy'])

# Przykładowa zmiana funkcji straty na Mean Squared Error
# model.compile(optimizer='adam', loss='mean_squared_error', metrics=['accuracy'])

# Przykładowa zmiana metryki oceny modelu na precyzję (precision)
